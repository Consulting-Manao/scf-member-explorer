/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: ca32aea501b38fff8c2a7a8c9e01ea64)
// Runtime types generated with workerd@1.20260915.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	NETWORK: "testnet";
	NETWORK_PASSPHRASE: "Test SDF Network ; September 2015";
	RPC_URL: "https://soroban-testnet.stellar.org";
	CONTRACT_ID: "CB5O6XFNHMMW6H42M7H3HOA736EOGHNTBWUA5B3T4LPIJXRFQ6WCLFZE";
	ATTESTER_PUBLIC: "GBAWJQEPO6KF3EWRYV4NQXJOUSCEYY3JNL6GZWKUKWAJKXOMPYUDPQ6C";
	IPFS_GATEWAY: "https://ipfs.filebase.io/ipfs/";
	PGATLAS_URL: "https://api.pgatlas.xyz";
	ROLE_SOURCE: "discord";
	DISCORD_GUILD_ID: "897514728459468821";
	DISCORD_ROLE_MAP: "{\"1082331251899379762\":3,\"1082353855041392731\":2,\"1082357854926807111\":1,\"1116373909504274534\":0}";
	DISCORD_CLIENT_ID: "1549691188368642078";
	GITHUB_CLIENT_ID: "Ov23lifVUXCy7ULe8eHz";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NETWORK" | "NETWORK_PASSPHRASE" | "RPC_URL" | "CONTRACT_ID" | "ATTESTER_PUBLIC" | "IPFS_GATEWAY" | "PGATLAS_URL" | "ROLE_SOURCE" | "DISCORD_GUILD_ID" | "DISCORD_ROLE_MAP" | "DISCORD_CLIENT_ID" | "GITHUB_CLIENT_ID" | "ATTESTER_SECRET" | "FILEBASE_TOKEN" | "GITHUB_CLIENT_SECRET" | "DISCORD_CLIENT_SECRET">> {}
}
